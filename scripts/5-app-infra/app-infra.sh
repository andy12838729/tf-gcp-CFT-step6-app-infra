...
TF_VARS=../../scripts/5-app-infra/bu1-development.auto.tfvars.json
COPY_LOCATION=.
...
TF_VARS=../../scripts/5-app-infra/bu1-non-production.auto.tfvars.json
COPY_LOCATION=.
[ -f $TF_VARS ] && { echo "Copying $TF_VARS to $COPY_LOCATION"; cp $TF_VARS $COPY_LOCATION; } || { echo "No $TF_VARS file found";  }
...
TF_VARS=../../scripts/5-app-infra/bu1-production.auto.example.tfvars.json
COPY_LOCATION=.
[ -f $TF_VARS ] && { echo "Copying $TF_VARS to $COPY_LOCATION"; cp $TF_VARS $COPY_LOCATION; } || { echo "No $TF_VARS file found";  }
...
TF_VARS=../../scripts/5-app-infra/common.auto.tfvars.json
COPY_LOCATION=.
[ -f $TF_VARS ] && { echo "Copying $TF_VARS to $COPY_LOCATION"; cp $TF_VARS $COPY_LOCATION; } || { echo "No $TF_VARS file found";  }
